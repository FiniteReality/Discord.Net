...
namespace Discord.Commands
{
    public struct CommandMatch
    {
        ...
        public Task<ParseResult> ParseAsync(ICommandContext context, SearchResult searchResult, PreconditionResult? preconditionResult = null, IDependencyMap map = null)
            => Command.ParseAsync(context, Alias.Length, searchResult, preconditionResult, map);
